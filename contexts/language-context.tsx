...
const translations: Record<Language, Record<string, string>> = {
  bn: {
    ...
    "hero.title": "আপনার যা দরকার, আমরা তাই প্রিন্ট করি।",
    "hero.subtitle": "কাস্টম প্রিন্টেড বিজনেস প্রোডাক্ট থেকে ফটো গিফট পর্যন্ত—সহজ ডিজাইন টুল ও সেবা দিয়ে ঠিক যেমন চান তেমন পাবেন।",
    "hero.tryTopProductsLine": "৳৫০০ থেকে টপ প্রোডাক্ট দেখুন",
    "hero.getStarted": "৳৫০০ এ ট্রাই করুন",
    "hero.bestselling": "বেস্টসেলিং পণ্য",
    "hero.designServices": "সেবা",
    "hero.watchDemo": "Watch Demo",
    // Home (trust strip & sections)
    "home.trustSince1989": "১৯৮৯ সাল থেকে",
    "home.trustDelivery": "দ্রুত ডেলিভারি",
    "home.trustFreeShipping": "ফ্রি ইকোনমি ডেলিভারি",
    "home.trustFreeShippingSub": "অর্ডার ৳৫০০০+ এ",
    "home.trustHelp": "যখন দরকার আমরা আছি",
    "home.trustHelpSub": "ফোন, ইমেইল ও লাইভ চ্যাটে আমরা আছি",
    "home.trustReviews": "৪৫০০+ পাঁচ তারার রিভিউ",
    "home.trustReviewsSub": "গ্রাহকদের রেটিং",
    "home.trustedByClients": "ক্লায়েন্টদের দ্বারা বিশ্বস্ত",
    "home.exploreCategories": "সব ক্যাটাগরি এক্সপ্লোর করুন",
    "home.featuredProducts": "পছন্দের পণ্য",
    "home.shopByCollection": "কালেকশন অনুযায়ী শপ করুন",
    "home.collectionTopProducts": "টপ প্রোডাক্ট (৳৫০০ থেকে)",
    "home.collectionGifts": "ক্লায়েন্ট ও কর্মীদের জন্য গিফট",
    "home.collectionBusiness": "বিজনেস এসেনশিয়াল",
    "home.collectionEvent": "ইভেন্ট ও ইনভাইটেশন",
    "home.collectionDesign": "ডিজাইন সেবা",
    "home.announcement1": "নির্বাচিত আইটেমে ২০% পর্যন্ত ছাড় | বিস্তারিত জানতে যোগাযোগ করুন",
    "home.announcement2": "দ্রুত ডেলিভারি | ঢাকা ও সারা বাংলাদেশে",
    "home.seeAllCollections": "সব কালেকশন দেখুন",
    "home.newArrivalsTitle": "ক্লথিং থেকে প্যাকেজিং—নতুন আগত পণ্য",
    "home.seeAll": "সব দেখুন",
    "home.promoLaunchTitle": "নতুন ব্যবসা চালু করুন",
    "home.promoLaunchSub": "আপনার স্বপ্ন আমরা বাস্তব করি। ব্যবসা শুরুর জন্য সব টুল ও পণ্য—প্রথম অর্ডারে ২০% ছাড়।",
    "home.promoDesignTitle": "ডিজাইন সেবা",
    "home.promoDesignSub": "কাস্টম ডিজাইন ও কোট পান। আমাদের ডিজাইনাররা আপনার ব্র্যান্ড অনুযায়ী সমাধান দেবেন।",
    "home.promoGetStarted": "শুরু করুন",
    "home.promoDesignCta": "ডিজাইন সেবা",
    // About
    ...
    // Footer
    "footer.tagline": "আপনার দরকার, আমরা প্রিন্ট করি, আপনি পছন্দ করবেন।",
    "footer.hereToHelp": "বার্ণিক প্রতিটি ধাপে সাহায্য করতে এখানে।",
    "footer.trustpilotText": "গ্রাহকরা আমাদের উৎকৃষ্ট রেটিং দিয়েছেন",
    "footer.letUsHelp": "সাহায্য নিন",
    "footer.ourCompany": "আমাদের সংস্থা",
    "footer.shipping": "ডেলিভারি",
    "footer.designHelp": "ডিজাইন সেবা",
    ...
    "breadcrumb.shop": "শপ",
    // Deals
    "deals.title": "অফার ও ডিল",
    "deals.subtitle": "বিশেষ অফার এবং ডিসকাউন্টের জন্য আমাদের সাথে যোগাযোগ করুন অথবা নিচের ক্যাটাগরি ব্রাউজ করুন।",
    "deals.contactForDeals": "বর্তমান অফার জানতে যোগাযোগ করুন",
    "deals.browseCategories": "ক্যাটাগরি ব্রাউজ করুন",
    // Design services
    "designServices.title": "ডিজাইন সেবা",
    "designServices.subtitle": "কাস্টম ডিজাইন, আর্টওয়ার্ক আপলোড এবং কোট রিকোয়েস্ট—আমাদের ডিজাইনাররা আপনার ব্র্যান্ড অনুযায়ী সমাধান দেবেন।",
    "designServices.cta": "যোগাযোগ করুন",
    "designServices.phone": "ফোন",
    "designServices.messenger": "মেসেঞ্জার",
    "designServices.footerNote": "আমরা আপনার ডিজাইন ও কোট রিকোয়েস্ট নিয়ে আলোচনা করতে পেরে খুশি হব।",
    // Common
  ...
  en: {
    ...
    "hero.title": "If you need it, we print it.",
    "hero.subtitle": "From custom-printed business products to photo gifts—get exactly what you want with our easy design tools and services.",
    "hero.tryTopProductsLine": "Try our top products starting at just ৳500 each",
    "hero.getStarted": "Try for ৳500",
    "hero.bestselling": "Bestselling products",
    "hero.designServices": "Services",
    "hero.watchDemo": "Watch Demo",
    // Home (trust strip & sections)
    "home.trustSince1989": "Since 1989",
    "home.trustDelivery": "Fast delivery",
    "home.trustFreeShipping": "Free economy shipping",
    "home.trustFreeShippingSub": "On orders ৳5,000+",
    "home.trustHelp": "Flexible help when you need it",
    "home.trustHelpSub": "We're here by phone, email & live chat",
    "home.trustReviews": "Over 4500 5-star reviews",
    "home.trustReviewsSub": "Rated by customers",
    "home.trustedByClients": "Trusted by clients",
    "home.exploreCategories": "Explore all categories",
    "home.featuredProducts": "Featured products",
    "home.shopByCollection": "Shop by collection",
    "home.collectionTopProducts": "Top products, from ৳500",
    "home.collectionGifts": "Gifts for clients & employees",
    "home.collectionBusiness": "Business essentials",
    "home.collectionEvent": "Event & invitations",
    "home.collectionDesign": "Design help",
    "home.announcement1": "Up to 20% off select items | Contact for details",
    "home.announcement2": "Fast delivery | Dhaka & nationwide",
    "home.seeAllCollections": "See all collections",
    "home.newArrivalsTitle": "Shop new arrivals, from clothing to packaging",
    "home.seeAll": "See all",
    "home.promoLaunchTitle": "Launch your new business",
    "home.promoLaunchSub": "You dream it, we help you start it. Get 20% off your first order.",
    "home.promoDesignTitle": "Design help",
    "home.promoDesignSub": "Get custom design and a quote. Our designers will help you get the right solution.",
    "home.promoGetStarted": "Get started",
    "home.promoDesignCta": "Design services",
    // About
    ...
    // Footer
    "footer.tagline": "You need it. We print it. You love it.",
    "footer.hereToHelp": "Barnick is here to help every step of the way.",
    "footer.trustpilotText": "Our customers rate us Excellent",
    "footer.letUsHelp": "Let Us Help",
    "footer.ourCompany": "Our Company",
    "footer.shipping": "Shipping",
    "footer.designHelp": "Design help",
    ...
    "deals.subtitle": "Contact us for current special offers and discounts, or browse our categories below.",
    "deals.contactForDeals": "Contact for current deals",
    "deals.browseCategories": "Browse categories",
    // Design services
    "designServices.title": "Design services",
    "designServices.subtitle": "Custom design, artwork upload, and quote requests—our designers will help you get the right solution for your brand.",
    "designServices.cta": "Get in touch",
    "designServices.phone": "Phone",
    "designServices.messenger": "Messenger",
    "designServices.footerNote": "We're happy to discuss your design and quote requests.",
    // Common

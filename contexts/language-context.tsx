...
const translations: Record<Language, Record<string, string>> = {
  bn: {
    ...
    "nav.contact": "যোগাযোগ",
    // Hero
    "hero.badge": "১৯৮৯ সাল থেকে বিশ্বস্ত প্রিন্টিং পার্টনার",
    "hero.title": "প্রিন্টিং ও প্যাকেজিং — সহজ, দ্রুত, নির্ভরযোগ্য",
    "hero.subtitle": "বিজনেস কার্ড থেকে ব্যানার — আপনার ব্র্যান্ডের সব প্রিন্টিং এক জায়গায়।",
  ...
  en: {
    ...
    "nav.contact": "Contact",
    // Hero
    "hero.badge": "Trusted printing partner since 1989",
    "hero.title": "Printing & Packaging — Easy, Fast, Trusted",
    "hero.subtitle": "From business cards to banners — all your brand printing in one place.",
